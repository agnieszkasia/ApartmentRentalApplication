    ...
    <div class="container mb-5 mt-5">
        <div class="cards shadow mt-5">
            ...
            <div class=" mr-4 ml-4 cards-header justify-content-between">
                <a href="/users" >AKTYWNI</a>
                <a href="/users/blocked" class="text-black-50">ZABLOKOWANI</a>
                <a href="/users/inactive" class="text-black-50">NIEAKTYWNI</a>
            </div>
                <div class="card-body">
                @foreach(\App\User::all() as $user)
                        @if(($user->type_of_user == 'user') && ($user->blocked == '0'))
                            <div class="mt-4">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="justify-content-between d-flex">
                                        ...
                                        <div><a href="/profile/{{ $user->id }}/block" class="mr-1 ml-1 btn-primary btn">Zablokuj</a></div>
