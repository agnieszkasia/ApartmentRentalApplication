        ...
        <div class="cards shadow mt-5">
            @can ('update', $user)
                ...
                <div class=" mr-4 ml-4 cards-header justify-content-between">
                    <a href="/profile/{{auth()->user()->id}}/flats" >AKTYWNE</a>
                    <a href="/profile/{{auth()->user()->id}}/flats/inactive" class="text-black-50">NIEAKTYWNE</a>
                </div>
            @endcan
            @cannot ('update', $user)
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            @can ('update', $user)
                                ...
                                <div class="d-flex justify-content-between float-right">
                                    ...
                                    <div><a class="btn btn-primary " href="/acceptrent/{{$flat->id}}" >Zaakcaptuj wynajem</a></div>
